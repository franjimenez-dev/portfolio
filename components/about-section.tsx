    ...
    return (
        <div>
            <p>
                ...
                Desde siempre me he caracterizado por un fuerte sentido de la responsabilidad y una gran curiosidad que
                me guía en busca de nuevos retos. Tengo una base sólida en
                ...
                className={"text-[#FDE68A] font-bold"}>MySQL</span>) y <span className={"text-[#FDE68A] font-bold"}>no relacionales</span> (<span
