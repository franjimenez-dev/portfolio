...
const SVGS = [
    {
        ...
        description: `He utilizado <a href="https://developer.mozilla.org/es/docs/Glossary/HTML5" class="text-[#FDE68A] font-bold tech-highlights-purple cursor-pointer ">HTML5</a> para estructurar el contenido de mis aplicaciones web. HTML5 es una tecnología fundamental en el desarrollo web moderno y proporciona una estructura semántica para organizar la información en páginas web. Además, he utilizado características avanzadas de HTML5 como <a href="https://developer.mozilla.org/es/docs/Web/HTML/Element/video" class="gradient-text font-bold gradient-text-animation-tech hover:scale-110">etiquetas de vídeo</a> y <a href="https://developer.mozilla.org/es/docs/Web/HTML/Element/audio" class="gradient-text font-bold gradient-text-animation-tech">etiquetas de audio</a> para crear experiencias multimedia en línea.`
    },
    {
        name: 'JavaScript',
        src: javascript_logo,
